...
for item in jsonResponse:
    if item['series']['network'] in configData['networkMaps']:
        network = configData['networkMaps'][item['series']['network']]
    else:
    ...
    if network in configData['networks']:
        ...
        print ("Adding: " + item['series']['title'] + " " + "S" + showSeason + "E" + showEpisode + " from " + network)
        ...
        if not path.exists(configData['basePath'] + "/" + item['series']['title'] + "/Season " + showSeason + "/" + network + "_S" + showSeason + "E" + showEpisode + ".mp4"):
            copyfile(configData['dummyFile'], configData['basePath'] + "/" + item['series']['title'] + "/Season " + showSeason + "/" + network + "_S" + showSeason + "E" + showEpisode + ".mp4")
